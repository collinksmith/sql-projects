...
def craiglockhart_to_sighthill
  ...
  FROM
    ...
    JOIN stops stopb ON b.stop_id = stopb.id
    WHERE
      stopa.name = 'Craiglockhart') from_c
    JOIN
     (SELECT
       stopb.name AS stop_name,
       a.company AS company,
     ...
     JOIN stops stopb ON b.stop_id = stopb.id
     WHERE
       stopa.name = 'Sighthill') from_s
    ON from_c.stop_name = from_s.stop_name
      AND from_c.line_num != from_s.line_num
